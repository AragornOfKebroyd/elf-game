...
def check_values():
    W = np.repeat(np.array([[0.5, 0, 0.5], [0.8, 0.1, 0.1], [0.5, 0.3, 0.2], [0, 0.1, 0.9], [0, 0, 1]]), repeats=(1, 1, 17, 4, 1), axis=0) # matches the overleaf doc
    ...
    print(ElfStats.EDc(0))
    print(ElfStats.VarDc(0))
...
def main():
    ...
    print(12 * E.EDc(0), 12**2 * E.VarDc(0))
